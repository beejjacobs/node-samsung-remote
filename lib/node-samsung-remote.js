...
class SamsungRemote {
  ...
  messageFirst() {
    ...
    let message = SamsungRemote.chr(0x64) +
    ...
    return NUL + SamsungRemote.chr(this.appString.length) +
        NUL + this.appString + SamsungRemote.chr(message.length) +
        NUL + message;
  }
  ...
  messageSecond(command) {
    ...
    return NUL + SamsungRemote.chr(this.tvAppString.length) +
        NUL + this.tvAppString + SamsungRemote.chr(message.length) +
        NUL + message;
  }
